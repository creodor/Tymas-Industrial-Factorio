...
{
  {
    ...
    minable = {hardness = 0.2, mining_time = 0.5, result = "imp-roboport"},
    max_health = 650,
    corpse = "big-remnants",
    ...
    charging_offsets =
    {
      {-1.5, -0.5}, {1.5, -0.5}, {1.5, 1.5}, {-1.5, 1.5}, {0, 0}, {-1, 0},
    },
    base =
    {
  ...
  },
  {
    ...
    icon = "__base__/graphics/icons/roboport.png",
    flags = {"placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "adv-roboport"},
    max_health = 800,
    corpse = "big-remnants",
    collision_box = {{-1.7, -1.7}, {1.7, 1.7}},
    selection_box = {{-2, -2}, {2, 2}},
    ...
    charging_offsets =
    {
      {-1.5, -0.5}, {1.5, -0.5}, {1.5, 1.5}, {-1.5, 1.5}, {0, 0}, {-1, 0}, {0, 1}, {0, -1}, {1, 0}, {2, 0},
    },
    base =
    {
      filename = "__base__/graphics/entity/roboport/roboport-base.png",
  ...
  },
  {
    ...
    minable = {	hardness = 0.1, mining_time = 0.1, result = "adv-logistic-robot"},
    max_health = 100,
  ...
  },
  {
    ...
    flags = {"placeable-player", "player-creation", "placeable-off-grid", "not-on-map"},
    minable = {hardness = 0.1, mining_time = 0.1, result = "adv-construction-robot"},
    max_health = 400,
    collision_box = {{0, 0}, {0, 0}},
    selection_box = {{-0.9, -1.5}, {0.9, -0.5}},
    max_payload_size = 11,
    ...
    repair_pack = "adv-repair-pack",  --{"adv-repair-pack", "repair-pack"}, does this even work? verify. NOPE.
    working_sound = flying_robot_sounds(),
    cargo_centered = {0.0, 0.2},
